...
/** 重新生成消息 GET /bot/app/assistant/chat-record/regenerate */
export async function getBotAppAssistantChatRecordRegenerate(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getBotAppAssistantChatRecordRegenerateParams,
  options?: { [key: string]: any },
) {
  return request<{
    code: number;
  ...
  }>('/bot/app/assistant/chat-record/regenerate', {
    method: 'GET',
    params: {
      ...params,
    },
