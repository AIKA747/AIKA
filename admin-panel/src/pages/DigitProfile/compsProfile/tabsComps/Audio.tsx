...
export default (prop: any) => {
  ...
  useEffect(() => {
    ...
    //     ...s?.digitHumanData,
    //     type: 'audio',
    //     greetVideoId: data?.greetVideoId,
    //     greetVideo: data?.greetVideo
    //   },
    // }));
  }, [data, setFileList]);
  ...
  return (
    <Dragger {...props} fileList={fileList}>
      ...
      <h2 className="ant-upload-text">Upload your own audio</h2>
      <h5 className="ant-upload-hint">Mp3 up to 15Mb</h5>
