...
class GptClient {
    ...
    @Value("\${ai.openai.websearchModel:gpt-4o-mini}")
    private val websearchModel: String? = null
    ...
    fun webSearch(input: String?): String {
        ...
        StaticLog.info("GptClient.webSearch(),postResp:{}", postResp)
        ...
        return content.getStr("text", "Just a reminder")
    }
