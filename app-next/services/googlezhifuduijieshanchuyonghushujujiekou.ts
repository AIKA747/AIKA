...
export async function deleteUserPublicOpenApiDeleteUserData(
  ...
  return request<{ code: number; msg: string; data: string }>('/user/public/delete/user/data', {
    method: 'DELETE',
    headers: {
...
export async function postUserPublicOpenApiDeleteUserDataSubmit(
  ...
  return request<{ code: number; msg: string; data: string }>('/user/public/delete/user/data/submit', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
