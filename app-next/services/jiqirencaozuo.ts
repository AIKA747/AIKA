...
export async function putBotAppBotId(
  ...
  return request<{ code: number; msg: string; data: API.BotDetailVO }>(`/bot/app/bot/${param0}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deleteBotAppBotId(
  ...
  const { id: param0, ...queryParams } = params;
  return request<{ code: number; msg: string; data: string }>(`/bot/app/bot/${param0}`, {
    method: 'DELETE',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function putBotAppBotIdRelease(
  ...
  const { id: param0, ...queryParams } = params;
  return request<{ code: number; msg: string; data: string }>(`/bot/app/bot/${param0}/release`, {
    method: 'PUT',
    params: { ...queryParams },
    ...(options || {}),
  });
