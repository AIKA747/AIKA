...
/** 删除列表中的聊天 DELETE /bot/app/chat-session */
export async function deleteBotAppChatSession(body: number[], options?: { [key: string]: any }) {
  return request<{ code: number; msg: string; data: string }>('/bot/app/chat-session', {
    method: 'DELETE',
    headers: {
...
export async function getBotAppChatroom(
  ...
  return request<{ code: number; msg: string; data: API.ChatGroupDetail }>('/bot/app/chatroom', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function getBotAppChatroomId(
  ...
  return request<{ code: number; msg: string; data: API.ChatGroupDetail }>(`/bot/app/chatroom/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function getBotAppChatroomFeatureMessages(
  ...
  return request<{
    code: number;
    msg: string;
    data: { total: number; pageNum: number; pageSize: number; pages: number; list: API.GroupChatMessageRecord[] };
...
export async function getBotAppChatroomGroupChatRecords(
  ...
  return request<{
    code: number;
    msg: string;
    data: { total: number; pageNum: number; pageSize: number; pages: number; list: API.ChatMessageBO[] };
...
export async function getBotAppChatroomMembers(
  ...
  return request<{
    code: number;
    msg: string;
    data: { total: number; pageNum: number; pageSize: number; pages: number; list: API.GroupMemberListVO[] };
