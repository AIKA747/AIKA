...
export async function putBotAppChatroom(
  ...
  return request<{ code: number; msg: string; data: number }>('/bot/app/chatroom', {
    method: 'PUT',
    headers: {
...
export async function postBotAppChatroom(
  body: {
    ...
    members?: { memberType: string; memberId: string; avatar: string; nickname: string; username: string }[];
...
/** 添加机器人到群聊中_2 仅现在群主添加机器人，最多添加2个 POST /bot/app/chatroom/${param0}/bot-memeber */
export async function postBotAppChatroomRoomIdBotMemeber(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.postBotAppChatroomRoomIdBotMemeberParams,
  body: {
    botId: string;
  },
  options?: { [key: string]: any },
  ...
  return request<{ code: number; msg: string; data: string }>(`/bot/app/chatroom/${param0}/bot-memeber`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
/** 移除群聊中的机器人 仅现在群主添加机器人，最多添加2个 DELETE /bot/app/chatroom/bot-memeber */
export async function deleteBotAppChatroomBotMemeber(
  body: {
    /** 群聊id */
    roomId: string;
    /** 机器人id */
  ...
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/bot-memeber', {
    method: 'DELETE',
    data: formData,
    requestType: 'form',
    ...(options || {}),
...
export async function putBotAppChatroomGroupType(
  ...
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/group-type', {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function putBotAppChatroomHistoryVisible(
  ...
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/history-visible', {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deleteBotAppChatroomMembers(
  ...
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/members', {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function putBotAppChatroomPermissions(
  ...
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/permissions', {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function putBotAppChatroomRole(
  ...
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/role', {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
