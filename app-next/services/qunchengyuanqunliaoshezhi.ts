...
export async function postBotAppChatroomRoomCode(
  ...
  return request<{ code: number; msg: string; data: number }>(`/bot/app/chatroom/${param0}`, {
    method: 'POST',
    params: { ...queryParams },
    data: formData,
    requestType: 'form',
...
export async function putBotAppChatroomApprove(
  ...
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/approve', {
    method: 'PUT',
    headers: {
...
export async function postBotAppChatroomGroupChatRecordFeatured(
  ...
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/group-chat-record/featured', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function deleteBotAppChatroomGroupChatRecordFeatured(body: string[], options?: { [key: string]: any }) {
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/group-chat-record/featured', {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
...
ONE_HOUR,EIGHT_HOUR,ONE_DAY,ONE_WEEK,ALWAYS */
  ...
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/member/notification-off', {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function putBotAppChatroomReject(
  ...
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/reject', {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function putBotAppChatroomTheme(
  ...
  return request<{ code: number; msg: string; data: string }>('/bot/app/chatroom/theme', {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
