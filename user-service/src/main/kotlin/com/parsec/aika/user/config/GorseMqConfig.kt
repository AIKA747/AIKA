...
import com.parsec.aika.user.config.GorseMqConst.GORSE_ITEM_ROUTE_KEY
...
class GorseMqConfig {
    ...
    fun bindGorseItemRouteKey(): Binding {
        return BindingBuilder.bind(gorseItemQueue()).to(gorseExchange()).with(GORSE_ITEM_ROUTE_KEY)
    }
